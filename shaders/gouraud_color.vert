...
void main() {
    ...
    vec3 normalLight = max(dot(normal, lightDirection), 0.0);
    diffuse = light_color * normalLight;
    ...
    vec3 reflectDirection = 2 * max(dot(normalLight * normal), 0.0) - lightDirection;
